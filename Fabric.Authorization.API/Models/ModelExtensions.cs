    ...
    public static class ModelExtensions
    {
        public static RoleApiModel ToRoleApiModel(this Role role)
        {
            var roleApiModel = new RoleApiModel
            {
                ...
                Name = role.Name,
                ParentRole = role.ParentRole?.ToRoleApiModel(),
                ChildRoles = role.ChildRoles?.Select(r => r.ToRoleApiModel()),
        ...
        public static Role ToRoleDomainModel(this RoleApiModel role)
        {
            var roleDomainModel = new Role
            {
                ...
                SecurableItem = role.SecurableItem,
                Name = role.Name,
                ParentRole = role.ParentRole?.ToRoleDomainModel(),
                ChildRoles = role.ChildRoles == null ? new List<Role>() : role.ChildRoles.Select(r => r.ToRoleDomainModel()).ToList(),
