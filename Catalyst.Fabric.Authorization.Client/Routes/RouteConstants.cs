namespace Catalyst.Fabric.Authorization.Client.Routes
{
    internal static class RouteConstants
    {
        ...
        public const string RoleCollectionRoute = "roles";
        public const string MemberCollectionRoute = "members";
        public const string SecurableItemCollectionRoute = "securableitems";
    }
}