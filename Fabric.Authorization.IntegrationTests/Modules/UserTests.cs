...
namespace Fabric.Authorization.IntegrationTests.Modules
{
    ...
    public class UserTests : IntegrationTestsFixture
    {
        ...
        public void Test_Delete_UserHasNoGranularPermissions()
        {
            ...
            Assert.Contains("The following permissions do not exist as 'allow' permissions: app/userprincipal.modifypatient", deleteRequest.Body.AsString());
            Assert.DoesNotContain("The following permissions exist as 'deny' for user but 'allow' was specified", deleteRequest.Body.AsString());
        ...
        public void Test_Delete_WrongPermissionAction()
        {
            ...
            Assert.Equal(HttpStatusCode.BadRequest, deleteRequest.StatusCode);
            Assert.Contains("The following permissions exist as 'allow' for user but 'deny' was specified: app/userprincipal.modifypatient", deleteRequest.Body.AsString());
        ...
        public void Test_Delete_WrongPermissionAction_InvalidPermission()
        {
            ...
            Assert.Contains("The following permissions exist as 'allow' for user but 'deny' was specified: app/userprincipal.modifypatient", deleteRequest.Body.AsString());
            Assert.DoesNotContain("The permissions do not exist as 'deny' permissions", deleteRequest.Body.AsString());
            Assert.Contains("The following permissions do not exist as 'allow' permissions: app/userprincipal.deletepatient", deleteRequest.Body.AsString());
            Assert.DoesNotContain("The following permissions exist as 'deny' for user but 'allow' was specified", deleteRequest.Body.AsString());
        ...
        public void Test_AddGranularPermission_Duplicate()
        {
            ...
            Assert.Contains("The following permissions already exist as 'allow' permissions: app/userprincipal.modifypatient", postResponse.Body.AsString());
        }
        ...
        public void Test_AddGranularPermssion_ExistsWithOtherAction()
        {
            ...
            Assert.Equal(HttpStatusCode.BadRequest, postResponse.StatusCode);
            Assert.Contains("The following permissions exist as 'allow' and cannot be added as 'deny': app/userprincipal.modifypatient", postResponse.Body.AsString());
        }
        ...
        public void Test_AddGranularPermission_ExistWithOtherAction_Duplicate()
        {
            ...
            Assert.Equal(HttpStatusCode.BadRequest, postResponse.StatusCode);
            Assert.Contains("The following permissions exist as 'allow' and cannot be added as 'deny': app/userprincipal.modifypatient", postResponse.Body.AsString());
            Assert.Contains("The following permissions already exist as 'allow' permissions: app/userprincipal.deletepatient, app/userprincipal.readpatient", postResponse.Body.AsString());
        }
